...
class ManajemenRisikoController extends Controller
{
     ...
     * Route: GET /manajemen-risiko/detail-unit/{unitKerja}/kegiatan/{kegiatanId}
     */
    ...
    public function updateTampilManajemenRisiko(Request $request)
    {
        ...
        try {
            // Update selected items to be visible
            ...
            return response()->json([
                'success' => true,
                'message' => count($request->selected_ids) . ' risiko berhasil ditampilkan!'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
