    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <form method="GET" action="{{ route('petas.tabel') }}" class="mb-3 row d-flex align-item-center">
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: data,
                        backgroundColor: [
                            '#3da5f4', // Biru untuk Sangat Rendah
                            '#47c363', // Hijau untuk Rendah  
                            '#ebda26', // Kuning untuk Sedang
                            '#ffa426', // Orange untuk Tinggi
                            '#df0b00' // Merah untuk Sangat Tinggi
                        ]
                    }]
                },
                options: {
