        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-primary border-bottom py-3">
                        <h6 class="mb-0 font-weight-bold text-white"></h6>
                                                ...
                                                <div class="d-flex justify-content-center align-items-center"
                                                    ...
                                                    @if ($surat->status == 'Draft')
                                                        <form action="{{ route('surat.finalize', $surat->id) }}"
                                                            ...
                                                            @csrf
                                                            <button type="submit"
                                                                class="btn btn-sm btn-primary shadow-sm d-flex align-items-center justify-content-center"
                                                                style="width: 32px; height: 32px;" data-toggle="tooltip"
                                                                title="Finalisasi">
                                                    ...
                                                    @if ($surat->file_scan)
                                                        <a href="{{ route('surat.view-scan', $surat->id) }}"
                                                            class="btn btn-sm btn-success shadow-sm d-flex align-items-center justify-content-center"
                                                    ...
                                                    @else
                                                        <button type="button"
                                                            class="btn btn-sm btn-secondary shadow-sm d-flex align-items-center justify-content-center"
                                                            style="width: 32px; height: 32px;"
